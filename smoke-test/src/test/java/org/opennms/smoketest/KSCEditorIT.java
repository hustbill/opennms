...
public class KSCEditorIT extends OpenNMSSeleniumTestCase {
    ...
    private String m_shareDir = "/Users/ranger/git/opennms-foundation/target/opennms-19.0.0-SNAPSHOT/share"; // = "/home/ranger/git/opennms/target/opennms-19.0.0-SNAPSHOT/share"
    ...
    protected void checkMainPage() throws Exception {
        ...
        assertElementDoesNotExist(By.name("report.0"));
        assertEquals("TestMachine1", findElementByName("resource.0").getText());
    }
    ...
    protected void createReport() throws Exception {
        ...
        clickElementByName("subresource.0");
        ...
        assertEquals("Smoke Test Report 1", findElementByName("report.0").getText());        

        // view the report to confirm it's right
        waitForElement(By.name("report.0"));
        Thread.sleep(100);
        clickElementByName("report.0");
