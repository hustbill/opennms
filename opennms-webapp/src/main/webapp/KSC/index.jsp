        ...
        <div class="panel-body">
          ...
          <div class="table-responsive">
            ...
            <table class="table table-condensed table-hover" name="reports">
              ...
              <tbody>
                <tr name="report.{{ $index }}" ng-class="{success: report.id == reportSelected.id}" ng-click="selectReport(report)" ng-repeat="report in filteredReports | startFrom:(kscCurrentPage-1)*kscPageSize | limitTo:kscPageSize">
                  <td>{{ report.label }}</td>
                </tr>
             </tbody>
            </table>
        ...
        <div class="panel-body">
          ...
          <div class="table-responsive">
            ...
            <table class="table table-condensed" name="resources">
              ...
              <tbody>
                <tr name="resource.{{ $index }}" ng-click="selectResource(resource)" ng-repeat="resource in filteredResources | startFrom:(currentPage-1)*pageSize | limitTo:pageSize">
