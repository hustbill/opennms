        ...
        <div class="panel-body">
          ...
          <div class="table-responsive" ng-show="resources.length > 0 && level < 2">
            ...
            <table class="table table-condensed table-hover ">
              ...
              <tbody>
                <tr name="subresource.{{ $index }}" ng-class="{success: resource.id == selectedResource.id}" ng-click="selectResource(resource)" ng-repeat="resource in filteredResources | startFrom:(currentPage-1)*pageSize | limitTo:pageSize">
